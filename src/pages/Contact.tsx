  ...
  const faqs = [
    {
      ...
      answer: 'Project timelines vary based on complexity and scope. Web development projects typically take 2-4 months, automation solutions 1-3 months, and ML projects 3-6 months.'
    },
    {
    ...
    },
    {
      ...
      answer: 'We follow an agile methodology with regular client check-ins, ensuring transparency and flexibility throughout the development process.'
    },
    {
      question: 'Can you work with our existing systems?',
      answer: 'Absolutely! We specialize in integrating new solutions with existing infrastructure and can work with virtually any technology stack.'
    }
  ];
            ...
            >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Certified professionals with 8+ years experience</p>
                    </div>
                  </div>
              ...
              <div className="card p-8">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  <a
                    href="#"
                    className="w-12 h-12 bg-gray-900 hover:bg-gray-800 rounded-full flex items-center justify-center transition-colors duration-300"
                  >
