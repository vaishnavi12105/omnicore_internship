  ...
  const values = [
    {
      icon: Target,
      title: 'Innovation',
      description: 'We stay at the forefront of technology, continuously exploring new solutions and methodologies to deliver cutting-edge results.'
    },
    {
      icon: Heart,
      title: 'Quality',
      description: 'Every project receives our full attention to detail, ensuring robust, scalable, and maintainable solutions that stand the test of time.'
    },
    {
      icon: Users,
      title: 'Collaboration',
      description: 'We work closely with our clients as partners, understanding their unique challenges and goals to deliver tailored solutions.'
    },
    {
      icon: TrendingUp,
      title: 'Results',
      description: 'Our success is measured by your success. We focus on delivering tangible outcomes that drive business growth and efficiency.'
    }
  ];
  ...
  const team = [
    {
      ...
      image: 'https://media.licdn.com/dms/image/v2/D5603AQHwrB_FWYKHTQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1723053575411?e=1758758400&v=beta&t=34yPgMP6BAM0KgRSyHLCnPt39f_OQ2SWuqegEfd0Whc',
      linkedin: '#',
      github: '#',
    ...
    },
    {
      name: 'N. Maanas Anand',
      role: 'CTO & Co-Founder',
      bio: 'A great Technical architect specializing in AI/ML and cloud infrastructure with knowledge in Operaring Systems',
      image: 'https://lh3.googleusercontent.com/a-/ALV-UjXhZMPDtBs5eLRkmHhD8W-n9pHPWnK1g5BS37AaBiuMtfEHqCU=s96-p-k-rw-no',
      linkedin: '#',
      github: '#',
    ...
    },
    {
      ...
      image: 'https://media.licdn.com/dms/image/v2/D4E03AQH1VEk9WleWiw/profile-displayphoto-scale_400_400/B4EZiUX_5HGoAk-/0/1754835976632?e=1758758400&v=beta&t=GKOsu3kJOWqqJOhUxAFXT18kmi4KRoe8IGmLymRyPH4',
      linkedin: '#',
      github: '#',
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  ...
                  known for our innovation, quality, and transformative impact. We envision a 
                  future where intelligent automation and AI-driven insights are accessible to 
                  all organizations.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="card p-8 text-center group hover:bg-blue-50 transition-colors duration-300"
              >
                <div className="w-16 h-16 bg-blue-100 group-hover:bg-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 transition-colors duration-300">
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <div className="lg:w-1/2 lg:pr-8">
                  <div className={`card p-6 ${index % 2 === 0 ? 'lg:text-right' : ''}`}>
              ...
              >
                <div className="relative mb-6">
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-24 h-24 rounded-full object-cover mx-auto mb-4 ring-4 ring-gray-100 group-hover:ring-blue-200 transition-all duration-300"
                  />
                </div>
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  <a
                    href={member.github}
                    className="w-8 h-8 bg-gray-100 hover:bg-gray-900 rounded-full flex items-center justify-center transition-colors duration-300 group"
                  >
                    <Github className="w-4 h-4 text-gray-600 group-hover:text-white" />
                  </a>
                  <a
                    href={`mailto:${member.email}`}
                    className="w-8 h-8 bg-gray-100 hover:bg-green-600 rounded-full flex items-center justify-center transition-colors duration-300 group"
                  >
