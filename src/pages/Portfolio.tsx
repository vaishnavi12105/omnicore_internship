...
const Portfolio = () => {
  ...
  return (
    <div className="pt-16 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="container-max">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              results through innovative software solutions.
            </p>
          </motion.div>
      ...
      {/* CTA Section */}
      <section className="section-padding relative overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600 dark:from-gray-900 dark:to-gray-800">
        {/* Overlay */}
        ...
        <div className="container-max relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed text-white/90 dark:text-gray-300">
              Join the growing list of successful businesses that have transformed their operations
              with our innovative solutions.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="bg-white text-blue-600 hover:bg-gray-100 font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-200">
                Start Your Project
              </button>
