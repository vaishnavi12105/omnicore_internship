  ...
  const processSteps = [
    {
      ...
      description: 'We start by understanding your business needs, challenges, and goals through detailed consultations and analysis.'
    },
    {
      step: '02',
      title: 'Strategy & Planning',
      description: 'Our team develops a comprehensive strategy and project roadmap tailored to your specific requirements.'
    },
    {
      step: '03',
      title: 'Design & Development',
      description: 'We create and build your solution using industry best practices and cutting-edge technologies.'
    },
    {
      step: '04',
      title: 'Testing & Optimization',
      description: 'Rigorous testing ensures your solution performs flawlessly and meets all quality standards.'
    },
    {
      step: '05',
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <div className="flex items-center mb-6">
                  <div className={`w-16 h-16 bg-${currentService.color}-100 rounded-2xl flex items-center justify-center mr-4`}>
                    <currentService.icon className={`w-8 h-8 text-${currentService.color}-600`} />
                  </div>
                  <h2 className="text-4xl font-bold text-gray-900">{currentService.title}</h2>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {currentService.offerings.map((offering, index) => (
                  ...
                  >
                    <div className={`w-12 h-12 bg-${currentService.color}-100 group-hover:bg-${currentService.color}-600 rounded-lg flex items-center justify-center mb-4 transition-colors duration-300`}>
                      <offering.icon className={`w-6 h-6 text-${currentService.color}-600 group-hover:text-white transition-colors duration-300`} />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2">{offering.title}</h3>
                    <p className="text-gray-600 mb-4 text-sm">{offering.description}</p>
                    <div className="flex flex-wrap gap-1">
                      {offering.technologies.map((tech) => (
                        <span key={tech} className="text-xs bg-gray-100 hover:bg-blue-100 text-gray-600 hover:text-blue-700 px-2 py-1 rounded transition-colors duration-300 cursor-default">
                          {tech}
                        </span>
                      ))}
                    </div>
